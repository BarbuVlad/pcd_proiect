...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                char raspuns_pentru_client_request6[200], rm_anunt_command_req6[80], categorie_req6[30], nume_anunt_req6[30], nume_user_req6[30];
                ...
                while(_rc_client = recv(accepted_sockfd, &_line_client, MAXLINE, 0))
                {
                    ...
                    // sterge dar e incomplet (poate sterge un anunt al altui user..trebuie adaugata o verificare pentru detinator anunt==user care vrea sa stearga)
                    {
                        ...
                        sscanf(_line_client,"%*s %s %s %s", categorie_req6, nume_anunt_req6 , nume_user_req6);
                        snprintf(rm_anunt_command_req6, sizeof(rm_anunt_command_req6), "rm ./%s/%s.*", categorie_req6, nume_anunt_req6);

                        if(strstr(nume_anunt_req6, nume_user_req6))
                        {
                        ...
                        {
                            snprintf(raspuns_pentru_client_request6, sizeof(raspuns_pentru_client_request6), "[ERROR] Nu sunteti proprietarul anuntului >%s< din categoria >%s<", nume_anunt_req6, categorie_req6);
                            write(accepted_sockfd, raspuns_pentru_client_request6, strlen(raspuns_pentru_client_request6));
                        }
